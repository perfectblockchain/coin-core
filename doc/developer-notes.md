...
Rizcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Rizcoin Core, where everyone uses
...
pay attention to for reviewers of Rizcoin Core code.

General Rizcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Rizcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
