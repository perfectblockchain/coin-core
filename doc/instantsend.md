...
This mechanism has been integrated into Bitcore-Node-Rizcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rizcoinpay/insight-api-rizcoin#web-socket-api](https://github.com/rizcoinpay/insight-api-rizcoin#web-socket-api)
* API: [https://github.com/rizcoinpay/insight-api-rizcoin#instantsend-transactions](https://github.com/rizcoinpay/insight-api-rizcoin#instantsend-transactions)
...
By default, the Rizcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rizcoin Core daemon:
