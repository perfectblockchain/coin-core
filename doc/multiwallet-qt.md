...
Only requiring some minor changes is rizcoin.cpp.
...
Changes to rizcoin.cpp
----------------------
rizcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
