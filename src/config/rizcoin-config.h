/* src/config/rizcoin-config.h.  Generated from rizcoin-config.h.in by configure.  */
/* src/config/rizcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef RIZCOIN_CONFIG_H

#define RIZCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/rizwallet-com/rizcoin-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rizcoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rizcoin Core 0.12.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "rizcoinCore"
