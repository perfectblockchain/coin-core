    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Rizcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rizcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rizcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Rizcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rizcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rizcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rizcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rizcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a rizcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rizcoin Core help message to get a list with possible Rizcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Rizcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rizcoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Rizcoin Core"); // default title
