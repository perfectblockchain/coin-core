...
#ifndef RIZCOIN_QT_BITCOINUNITS_H
#define RIZCOIN_QT_BITCOINUNITS_H
...
/** Rizcoin unit definitions. Encapsulates parsing and formatting
...
#endif // RIZCOIN_QT_BITCOINUNITS_H
