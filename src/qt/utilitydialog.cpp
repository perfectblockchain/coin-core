    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Rizcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Rizcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rizcoin-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        std::string strUsage = HelpMessage(HMM_RIZCOIN_QT);
...
All the Rizcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RIZ, 0.1 RIZ, 1 RIZ and 10 RIZ -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rizcoinpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://rizcoinpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Rizcoin Core is shutting down...") + "<br /><br />" +
