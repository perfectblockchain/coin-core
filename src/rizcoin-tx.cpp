...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Rizcoin Core rizcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rizcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rizcoin transaction") + "\n" +
              "  rizcoin-tx [options] -create [commands]   " + _("Create hex-encoded rizcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rizcoin transaction
