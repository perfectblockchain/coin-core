...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total rizcoin balance of the wallet\n"
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized rizcoin balance of the wallet\n"
...
UniValue debug(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "rizcoin|privatesend|instantsend|masternode|spork|keepass|mnpayments|gobject )\n"
            "Change debug category on the fly. Specify single category or use comma to specify many.\n"
            "\nExamples:\n"
            + HelpExampleCli("debug", "rizcoin")
            + HelpExampleRpc("debug", "rizcoin,net")
        );
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"rizcoinaddress\"\n"
            "\nReturn information about the given rizcoin address.\n"
            "\nArguments:\n"
            "1. \"rizcoinaddress\"     (string, required) The rizcoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"rizcoinaddress\", (string) The rizcoin address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"")
            + HelpExampleRpc("validateaddress", "\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"")
        );
...
#ifdef ENABLE_WALLET
        // Case 1: Rizcoin address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are rizcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) rizcoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"rizcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"rizcoinaddress\"  (string, required) The rizcoin address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}")
        );
...
UniValue getaddressutxos(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}")
        );
...
UniValue getaddressdeltas(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1 || !params[0].isObject())
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}")
        );
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}")
        );
...
UniValue getaddresstxids(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"RUfxdcfdtQX9KiX3JScqy2ENSsLyELBbAs\"]}")
        );
