...
#define BOOST_TEST_MODULE Rizcoin Test Suite

#include "test_rizcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_rizcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
