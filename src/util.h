 ...
 */
#ifndef RIZCOIN_UTIL_H
#define RIZCOIN_UTIL_H
...
//#define ENABLE_RIZCOIN_DEBUG
#ifdef ENABLE_RIZCOIN_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
...
extern const char * const RIZCOIN_CONF_FILENAME;
extern const char * const RIZCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("rizcoin-%s", name);
